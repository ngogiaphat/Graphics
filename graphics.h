...
// * Please see http://www.cs.colorado.edu/~main/bgi for information on using this library with the mingw32 g++ compiler.
...
//                          Definitions
// ---------------------------------------------------------------------------
// Definitions for the key pad extended keys are added here.  When one of these keys are pressed, getch will return a zero followed by one
// of these values. This is the same way that it works in conio for dos applications.
#define KEY_HOME        71
#define KEY_UP          72
#define KEY_PGUP        73
#define KEY_LEFT        75
...
//                              Structures
// ---------------------------------------------------------------------------
// This structure records information about the last call to arc.  It is used by getarccoords to get the location of the endpoints of the arc.
...
// This structure defines the fill style for the current window.  Pattern is one of the system patterns such as SOLID_FILL.  Color is the color to fill with
...
// This structure records information about the current line style. linestyle is one of the line styles such as SOLID_LINE, upattern is a
// 16-bit pattern for user defined lines, and thickness is the width of the line in pixels.
